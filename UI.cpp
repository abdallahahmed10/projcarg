...
void UI::Interactive_StepByStep(Company* pcompany)
{
	...
	cout << "-------------------------------------------------" << endl;
	cout << pcompany->GetNoLoadingTrucks()<< " Loading Trucks: " ;
	pcompany->print_loading_truck();
	cout <<endl<< "-------------------------------------------------" << endl;
	...
	cout << pcompany->GetNoMovingCargos()<< " Moving Cargos: " ;
	pcompany->print_moving_truck();
	cout<<endl << "-------------------------------------------------" << endl;

	cout << pcompany->GetNoInCheckupTrucks()<< " InCheckup Trucks: " << endl;
	cout << "-------------------------------------------------" << endl;

	cout << pcompany->GetNoDeliveredCargos() << " Delivered Cargos: ";
	pcompany->print_delivered_cargos();
	cout << "-------------------------------------------------" << endl << endl;
